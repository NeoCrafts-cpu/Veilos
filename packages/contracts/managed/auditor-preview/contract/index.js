...
class _DisclosurePublic_0 {
  ...
  fromValue(value_0) {
    return {
      auditorId: _descriptor_1.fromValue(value_0),
      scopeCommitment: _descriptor_1.fromValue(value_0),
      expires: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.auditorId).concat(_descriptor_1.toValue(value_0.scopeCommitment).concat(_descriptor_2.toValue(value_0.expires)));
  }
}

const _descriptor_3 = new _DisclosurePublic_0();
...
export class Contract {
  ...
  constructor(...args_0) {
      ...
      recordDisclosure: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('recordDisclosure',
                                     ...
                                     'auditor-preview.compact line 42 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(disclosureId_0).concat(_descriptor_1.toValue(auditorId_0).concat(_descriptor_1.toValue(scopeCommitment_0).concat(_descriptor_2.toValue(expires_0)))),
            alignment: _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_2.alignment())))
          },
          output: undefined,
          publicTranscript: [],
    ...
    this.impureCircuits = { recordDisclosure: this.circuits.recordDisclosure };
  ...
  initialState(...args_0) {
    ...
    if (!(orgId_0.buffer instanceof ArrayBuffer && orgId_0.BYTES_PER_ELEMENT === 1 && orgId_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'auditor-preview.compact line 36 char 1',
                                 'Bytes<32>',
                                 orgId_0)
    }
  ...
  _ownerSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('ownerSecret',
                                 'return value',
                                 'auditor-preview.compact line 23 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_10.toValue(3n),
                                                                                                                   alignment: _descriptor_10.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(publicId_0),
                                                                                                                                               alignment: _descriptor_1.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                             ...
                             _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value)),
                            'clock missing');
    const tmp_1 = { auditorId: auditorId_0,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'auditor-preview.compact line 20 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({ ownerSecret: (...args) => undefined });
  ...
  ownerCommitmentOf: (...args_0) => {
    ...
    if (!(sk_0.buffer instanceof ArrayBuffer && sk_0.BYTES_PER_ELEMENT === 1 && sk_0.length === 32)) {
      __compactRuntime.typeError('ownerCommitmentOf',
                                 'argument 1',
                                 'auditor-preview.compact line 25 char 1',
                                 'Bytes<32>',
                                 sk_0)
    }
